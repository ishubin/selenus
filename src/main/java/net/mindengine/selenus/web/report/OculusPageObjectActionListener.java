...
public class OculusPageObjectActionListener implements PageObjectActionListener {
	...
	@Override
	public void onDragAndDrop(AbstractPageObject pageObject,
			AbstractPageObject targetPageObject) {
		// TODO Auto-generated method stub

	}

	@Override
	public void onDragAndDropBy(AbstractPageObject pageObject, int xOffset,
			int yOffset) {
		// TODO Auto-generated method stub
